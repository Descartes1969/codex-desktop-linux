...
Installs the chrome-sandbox helper from the locally generated Electron app.
The normal upstream build must create the app first; this script downloads or
redistributes no binary.
EOF
}
...
source_helper="$app_dir/chrome-sandbox"
